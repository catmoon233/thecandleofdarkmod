...
package net.mcreator.tcod.item;
...
import net.mcreator.tcod.gui.BeibaoGuiWindow;
import net.mcreator.tcod.gui.BeibaoGui;
...
public class Xiaobao2Item extends TcodModElements.ModElement {
	@ObjectHolder("tcod:xiaobao_2")
	public static final Item block = null;

	public Xiaobao2Item(TcodModElements instance) {
		super(instance, 5);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof BeibaoGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Xiaobao 2");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new BeibaoGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
